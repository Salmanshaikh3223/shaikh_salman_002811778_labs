...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Product product = (Product) tblProducts.getValueAt(index, 0);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
        SearchForProductJPanel panel = new SearchForProductJPanel(workArea, supplier);
        workArea.add("SearchForProductJPanel", panel);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        Product productToDelete = (Product) tblProducts.getValueAt(row, 0);
        supplier.getProductCatalog().removeProduct(productToDelete);
        refreshTable();
